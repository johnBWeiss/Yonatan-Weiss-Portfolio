...
import LearnAI from "../../assets/videos/TITANWAR.mp4"
...
const videosList = [

    {
        ...
        description: `A web app designed to help you find the best free-to-play games!
You can search by categories, or browse through the entire list sorted by the latest release date.
If you want to read more about each game or even aquire one, just click on one of the results,
 and then choose the option you would like in the ensuing pop up window.
Happy Gamin'!`
    },
    ...
    },
    {
        ...
        description: `An enterprise-level onboarding tool for junior developers, designed to optimize the efficiency
         of newly recruited team members. With this tool, you can access the most effective methods to enhance 
         the onboarding process, ensuring that your team members can quickly and efficiently integrate
